...
function converteValor() {
    var valorAtual = document.getElementById('valor').value
    var cotacaoDoDolar = 5.13;
    var cotacaoDoPesoArgentino = 0.027;
    var cotacaoDoEuro = 5.57;
    alert("Dólar ($): " + "R$ " + (valorAtual * cotacaoDoDolar).toFixed(2));
    alert("Peso Argentino ($): " + "R$ " + (valorAtual * cotacaoDoPesoArgentino).toFixed(2));
    alert("Euro (€): " + "R$ " + (valorAtual * cotacaoDoEuro).toFixed(2));
}